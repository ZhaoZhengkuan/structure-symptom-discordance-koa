...
# Project root; override with the C1_PROJECT environment variable.
ROOT = Path(os.environ.get("C1_PROJECT", Path(__file__).resolve().parents[2]))
TABLES = ROOT / "outputs" / "tables"
OUT = ROOT / "outputs" / "upgrades"
